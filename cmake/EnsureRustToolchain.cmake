...
# Configuration
set(RUST_REQUIRED_CHANNEL
    "nightly"
    CACHE STRING "Required Rust channel (stable, beta, nightly)")
set(RUST_LOCAL_DIR
    "${CMAKE_SOURCE_DIR}/_deps/rust"
    CACHE PATH "Local Rust installation directory")
...
function(ensure_rust_toolchain)
  ...
  if(EXISTS "${LOCAL_CARGO}")
    ...
    if(IS_NIGHTLY OR NOT RUST_REQUIRED_CHANNEL STREQUAL "nightly")
      set(RUST_TOOLCHAIN_READY
          TRUE
          PARENT_SCOPE)
      set(CARGO_EXECUTABLE
          "${LOCAL_CARGO}"
          PARENT_SCOPE)
      set(RUSTC_EXECUTABLE
          "${LOCAL_RUSTC}"
          PARENT_SCOPE)
      set(RUSTUP_EXECUTABLE
          "${LOCAL_RUSTUP}"
          PARENT_SCOPE)
